...
static TextStyle font16MainRed = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.mainRed,
  );
 static TextStyle font17MainRed = TextStyle(
    fontSize: 17.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.mainRed,
  );
  static TextStyle font18MainRed = TextStyle(
    fontSize: 18.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.mainRed,
  );
  ...
  static TextStyle font15WhiteBold = TextStyle(
   ...
   static TextStyle font15MainRed = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.mainRed,
  );
  static TextStyle font20MainRed = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.mainRed,
  );
  ...
  static TextStyle font9_2BlackBold = TextStyle(
    fontSize: 9.5.sp,
    fontWeight: FontWeightHelper.regular,
    color: Colors.black,
  );

  static TextStyle font9BlackBold = TextStyle(
    fontSize: 9.sp,
    fontWeight: FontWeightHelper.regular,
    color: Colors.black,
  );
  ...
  static TextStyle font8_5GrayRegular = TextStyle(
    fontSize: 8.5.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.gray,
  );

  static TextStyle font7WhiteBold = TextStyle(
    fontSize: 7.sp,
    fontWeight: FontWeightHelper.bold,
    color: Colors.white,
  );
  ...
  static TextStyle font15MainBlueMedium = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.mainBlue,
  );
