    ...
    return Stack(children: [
      ...
      if(eventDuration != null && !Provider.of<ThemeProvider>(context, listen: false).darkTheme)
        Positioned(bottom: -20,left: -6,
            child: SizedBox(width: 60, child: Image.asset(AppAssets.currentShape, opacity: const AlwaysStoppedAnimation(.05),))),

      if(eventDuration != null && !Provider.of<ThemeProvider>(context, listen: false).darkTheme)
      Positioned(top: -1,left: MediaQuery.of(context).size.width/3.3,
          child: SizedBox(width: 35, child: Image.asset(AppAssets.currentShape, opacity: const AlwaysStoppedAnimation(.15),))),

      if(eventDuration != null && !Provider.of<ThemeProvider>(context, listen: false).darkTheme)
      Positioned(right: -2,top: -10,
          child: SizedBox(width: 25, child: Image.asset(AppAssets.currentShape, opacity: const AlwaysStoppedAnimation(.17),))),
      ...
      Positioned(
        child: Align(alignment: Alignment.center,
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              isFlash? Image.asset(AppAssets.flashDeal, scale: 4):const SizedBox(),
